...
return new class extends Migration
{
    ...
    {
        Schema::create('product_advertise_special', function (Blueprint $table) {
            ...
            $table->string('background',250)->nullable()->default('NULL');
    ...
    {
        Schema::dropIfExists('product_advertise_special');
    }
};
